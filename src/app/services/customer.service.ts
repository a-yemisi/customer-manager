...
export class CustomerService {
  ...
  getCustomers(): Observable<ICustomers> {
    return this.httpClient
      .get<ICustomers>('https://jsonplaceholder.typicode.com/users')
      .pipe(
  ...
  createCustomers(data: ICustomer): Observable<ICustomer> {
    return this.httpClient
      .post<ICustomer>('https://jsonplaceholder.typicode.com/users', data)
      .pipe(
  ...
  deleteCustomers(id: number): Observable<void> {
    return this.httpClient
      .delete<void>(`https://jsonplaceholder.typicode.com/users/${id}`)
      .pipe(
        tap(() => {
